...
function App() {
  ...
  const [imagemBiscoito, setImagemBiscoito] = useState(true);
  ...
  function quebraBiscoito(){
    ...
    setImagemBiscoito(false);

    clearTimeout(timeoutRef.current);

    timeoutRef.current = setTimeout(() => {
      setImagemBiscoito(true);
      setFrase('');
    }, 2500);
  }
  ...
  return(
    <div className="container">
      ...
      <Biscoito imagemBiscoito={imagemBiscoito} acaoClick={quebraBiscoito} />
